                ...
                <v-card-text>
                    ...
                    <v-row>
                        ...
                        <v-col cols="4">
                            ...
                            <br/>
                            <v-input :messages="['Dirección']" dense prepend-icon="mdi-pin">{{selectedSale.address.address}}</v-input>
                            <br/>
                            <v-input :messages="['Cliente']" prepend-icon="mdi-account">{{selectedSale.user.name}}</v-input>
                            <br/>
                            <v-row>
                            <v-col cols="4">
                            ...
                            <br/>
                            <v-input :messages="['Tipo entrega']" prepend-icon="mdi-cube-send">
                            ...
                            <br/>
                            <v-btn  v-if="selectedSale.status.id<=4" dark color="danger" @click="cancelOrder">
                                CANCELAR PEDIDO
                            </v-btn>
                        </v-col>
                    </v-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            viewSale(sale) {
                axios.get('/sales/' + sale.id + '/products')
                    .then(response => {
            ...
            updateSaleDelivery() {
                ...
                axios.post('/sale/delivery/update', {id:this.selectedSale.id, delivery_id:this.deliveryMan})
                    .then(response => {
