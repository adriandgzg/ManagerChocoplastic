    ...
    <v-row>
      <v-col>
        ...
        <v-row> 
            ...
            <v-col cols="3">
              <v-card-text class="category d-inline-flex font-weight-light">  
              <v-label><h4>Sucursal Salida:</h4> 
              {{editadoHeader.stor_name_output}}</v-label>             
              </v-card-text>
            </v-col>  
            <v-col cols="3">
              <v-card-text class="category d-inline-flex font-weight-light">   
              <v-label><h4>Sucursal Salida:</h4>        
              {{editadoHeader.stor_name_input}}</v-label>
              </v-card-text>
            </v-col>  
            <v-col cols="3">
                <v-card-text class="category d-inline-flex font-weight-light">   
                    <v-label><h4>Observación:</h4>        
              {{editadoHeader.prtr_observation}}</v-label>
              </v-card-text>  
            </v-col>
          </v-row>
          <v-row>
