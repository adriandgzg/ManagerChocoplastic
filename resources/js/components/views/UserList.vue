                ...
                <template v-slot:top>
                    ...
                    <v-toolbar flat color="indigo">
                        <template v-slot:extension>
                            <v-btn fab color="cyan accent-2" bottom left absolute @click="dialogForm = !dialogForm">
    ...
    <v-dialog v-model="dialogForm" max-width="800px">
        ...
        <v-card>
            ...
            <v-form v-model="valid">
                <v-card-text>
                    <v-container>
                        <v-text-field v-model="editado.name" label="Nombre" maxlength="300" :rules="nameRules" required></v-text-field>
                        <v-text-field v-model="editado.email" label="Email" maxlength="300" :rules="[rules.required, rules.email]" required></v-text-field>
                        <v-text-field v-model="editado.phone_number" label="No. Empleado" maxlength="300" :rules="nameRules" required></v-text-field>
                        <v-text-field v-model="editado.password" label="Contraseña" maxlength="300" :rules="[rules.required, rules.min]" :append-icon="show1 ? 'mdi-eye' : 'mdi-eye-off'" :type="show1 ? 'text' : 'password'" @click:append="show1 = !show1"></v-text-field>
                        <v-select v-model="gender" :items="genders" item-text="name" item-value="name" filled chips label="Género" placeholder="Selecciona su Género"></v-select>
            ...
            <v-form v-model="validUpdate">
                <v-card-text>
                    <v-container>
                        <v-text-field v-model="editado.name" label="Nombre" maxlength="300" :rules="nameRules" required></v-text-field>
                        <v-text-field v-model="editado.email" label="Email" maxlength="300" :rules="[rules.required, rules.email]" required></v-text-field>
                        <v-text-field v-model="editado.phone_number" label="No. Empleado" maxlength="300" disabled></v-text-field>
