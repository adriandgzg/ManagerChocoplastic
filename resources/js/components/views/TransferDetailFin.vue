            ...
            <v-col>
                <v-card>
                    <v-row>
                        <v-col cols="6">
                            <v-card-text class="category d-inline-flex font-weight-light">
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        <div class="overline mb-4">SUCURSAL DE SALIDA</div>
                                        <v-list-item-title>{{editadoHeader.stor_name_output}}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card-text>
                        </v-col>
                        <v-col cols="6">
                            <v-card-text class="category d-inline-flex font-weight-light">
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        <div class="overline mb-4">SUCURSAL DE ENTRADA</div>
                                        <v-list-item-title>{{editadoHeader.stor_name_input}}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card-text>
                        </v-col>
                    ...
                    <v-row>
                        <v-col>
                            <v-card-text class="category d-inline-flex font-weight-light">
                                <!--<v-textarea v-model="prtr_observation" auto-grow filled color="deep-purple" label="Observaciones" rows="3"></v-textarea>-->
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        <div class="overline mb-4">OBSERVACIONES</div>
                                        <v-list-item-title>{{editadoHeader.prtr_observation}}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card-text>
                        </v-col>
                        ...
                        <template v-slot:default>
                            ...
                            <tbody>
                                <tr v-for="item in desserts" :key="item.prod_name">
                                    ...
                                    <td>
                                        <v-text-field v-model="item.prtd_quantity" label @change="onQuantityChange(item)" required></v-text-field>
                                    </td>
                                    <td>
...
export default {
    ...
    methods: {
        ...
        agregar(item) {
            ...
            axios
                .post("/product/transfer/details", this.detail)
                .then((response) => {
        ...
        onQuantityChange(item) {
            ...
            axios
                .post("/product/transfer/details/update", this.detail)
                .then((response) => {
                    console.log(response);
                    if (response.data.status.code == 200) {
                        this.textMsg = "¡Actualizado correctamente!";
        ...
        getTotal() {
            ...
            for (var i = 0; i < this.desserts.length; i++) {
                this.subtotal =
                    this.subtotal +
                    this.desserts[i].prtd_price *
                    this.desserts[i].prtd_quantity *
                    (1 - this.desserts[i].prtd_discountrate / 100);
        ...
        guardaFinalizar() {
            ...
            axios
                .post("/product/transfers/update/finalize", this.orderHeader)
                .then((response) => {
                    console.log(response);
