                    ...
                    <v-row>
                        <v-col cols="4">
                            <v-card-text class="category d-inline-flex font-weight-light">
                                <v-combobox required v-model="selectStore" :items="stores" label="Sucursal" :disabled="enabledStore" item-text="stor_name" item-value="stor_pk" filled chips placeholder="Seleccionar una sucursal"></v-combobox>
                            </v-card-text>
                        </v-col>
                        <v-col cols="8">
                            <v-card-text class="category d-inline-flex font-weight-light">
...
export default {
    ...
    methods: {
        ...
        guardaFinalizar() {
            ...
            axios
                .post("/product/transfers/update", this.orderHeader)
                .then((response) => {
                    console.log(response);
