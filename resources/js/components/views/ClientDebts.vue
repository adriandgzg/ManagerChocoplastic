            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form v-model="valid">
                        <v-row>
                            <v-col cols="6">
                                <h4> No. Venta:</h4> {{editado.clsa_identifier}}
                            </v-col>
                            <v-col cols="6">
                                <h4> Monto total:</h4> ${{formatMoney(editado.clde_amount)}}
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col cols="6">
                                <h4> Monto pagado:</h4> ${{formatMoney(editado.clde_amount_paid)}}
                            </v-col>
                            <v-col cols="6">
                                <h4> Monto pendiente:</h4> ${{formatMoney(editado.clde_amount_outstanding)}}
                            </v-col>
                        </v-row>
