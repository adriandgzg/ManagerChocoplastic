<template>
    <v-app>
        <v-container>
            ...
            <v-dialog v-model="dialog" max-width="500px" persistent>
                <v-card>
                    ...
                    <v-form v-model="validProvider" >
                        <v-card-text>
                            <v-text-field v-model="editado.feen_name" label="Nombre" maxlength="300"
            ...
            <v-col>
                <v-card>
                    <v-data-table :headers="headers" :items="entities" :search="search" sort-by="id" class="elevation-3">
                    <template v-slot:top>
                    <v-system-bar color="indigo darken-2" dark></v-system-bar>
                        <v-toolbar flat color="indigo">
                            ...
                            <v-toolbar-title class="white--text">Lista de Entidades</v-toolbar-title>
...
export default {
  ...
  methods: {
    ...
    guardar() {
        ...
        if(this.estado == true)
            this.editado.feen_status =  1;
        else
            this.editado.feen_status =  0;
    ...
    alta: function () {
        axios.post('/entities/add', this.editado).then(response => {
            this.snackbar = true
