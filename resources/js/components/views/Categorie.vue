...
<v-app>
    <v-container>
        ...
        <v-dialog v-model="dialog" max-width="500px" persistent>
            <v-card>
                ...
                <v-form v-model="validProvider">
                    <v-card-text>
                        <v-text-field v-model="editado.prca_name" label="Nombre" maxlength="300" :rules="nameRules" required></v-text-field>
        ...
        <v-row>
            <v-col>
                <v-card>
                    <v-data-table :headers="headers" :items="categories" :search="search" sort-by="id" class="elevation-3" :loading="loading" loading-text="Cargando... Espere un momento.">
                        <template v-slot:top>
