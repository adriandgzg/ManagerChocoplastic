            ...
            <v-dialog v-model="dialog" max-width="500px" persistent>
                <v-card>
                    ...
                    <v-form v-model="validProvider" >
                        <v-card-text>
                            <v-text-field v-model="editado.pash_name" label="Nombre" maxlength="300"
                ...
                <v-card>
                    ...
                    <v-system-bar color="indigo darken-2" dark></v-system-bar>
                        <v-toolbar flat color="indigo">
                            ...
                            <v-toolbar-title class="white--text">Lista de Formas de Pago</v-toolbar-title>
                    ...
                    <template v-slot:item.status="{ item }">                            
                            <v-chip v-if="item.pash_status == 1" color="green" dark>  Activo  </v-chip>
...
export default {
  ...
  methods: {
    ...
    guardar() {
        ...
        if(this.estado == true)
            this.editado.pash_status =  1;
        else
            this.editado.pash_status =  0;
    ...
    alta: function () {
        axios.post('/paymentshapes/add', this.editado).then(response => {
            this.snackbar = true
