            ...
            <template v-slot:default>
              ...
              <tbody>
                <tr v-for="item in desserts" :key="item.prod_name">
                  ...
                  <td>
                  <v-text-field v-model="item.ppod_quantity" label=""
                        @change="onQuantityChange(item)" required></v-text-field>
                  </td>
                  <td><v-text-field v-model="item.ppod_providerprice" label=""
                        @change="onQuantityChange(item)" required></v-text-field></td>
                  <td><v-text-field v-model="item.ppod_discountrate" label=""
                        @change="onQuantityChange(item)" required></v-text-field></td>
