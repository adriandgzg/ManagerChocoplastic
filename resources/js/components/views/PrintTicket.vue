                ...
                <v-row>
                    <v-col cols="4">
                        <v-card-text class="category d-inline-flex font-weight-light">
                            <v-select :items="clientes" label="Cliente" item-text="name" item-value="id" filled chips placeholder="Seleccionar Cliente"></v-select>
                        </v-card-text>
                    </v-col>
                    <v-col cols="4">
                        <v-card-text class="category d-inline-flex font-weight-light">
    ...
    <v-dialog v-model="dialogcredito" max-width="500">
        <v-card>
            ...
            <v-card-text>
                ...
                <v-text-field label="Efectivo: " required :rules="minNumberRules" prefix="$" type="number"></v-text-field>
