                ...
                <v-card>
                    <v-data-table :headers="headers" :items="ordenescompra" :search="search" sort-by="id" class="elevation-3">
                        ...
                        <template v-slot:item.action="{ item }">
                            ...
                            <v-btn class="mr-2" fab dark small color="pink" v-if="item.prpu_status_description != 'Pendiente' && item.prpu_status_description != 'Cancelada' && item.cantreturn == 0" :href="'/providersreturn/'+item.prpu_pk" title="Devolución">
