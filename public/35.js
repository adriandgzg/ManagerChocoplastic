...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    GenerarReporte: function GenerarReporte() {
      ...
      window.open( //"http://3.217.161.164:777/?pRep=1&pProd_PK=1&pStor_PK=&pDateStart=&pDateEnd=http://52.90.189.143:8000/SMR/?pRep=1&pDateStart=" +
      "http://3.217.161.164:777/?pRep=1&pProd_PK=" + this.select_products + "&pStor_PK=" + this.select_stores + "&pDateStart=" + this.start_date + "&pDateEnd=" + this.end_date + "&pUser_PK=" + this.users.id, "_blank");
    },
