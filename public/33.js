  ...
  data: function data() {
    ...
    return {
      ...
      editadoHeader: (_editadoHeader = {
        ...
        created_at: '',
        updated_at: ''
      }, _defineProperty(_editadoHeader, "prpu_type", ''), _defineProperty(_editadoHeader, "prpu_observation", ''), _editadoHeader),
      editado: {
        prpd_pk: 0,
        prpd_quantity: 0,
        prpd_price: 0,
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c("v-label", [
                                    _c("h3", [
                                      _vm._v("Número Nota / Factura:")
                                    ]),
                                    _vm._v(
                                      " " +
                                        _vm._s(
                                          _vm.editadoHeader.prpu_observation
                                        ) +
                                        "\r\n                                "
                                    )
                                  ])
