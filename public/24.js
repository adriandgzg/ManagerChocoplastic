...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return {
      ...
      defaultItem: (_defaultItem = {
        ...
        prod_identifier: '',
        prod_name: ''
      }, _defineProperty(_defaultItem, "prod_name", ''), _defineProperty(_defaultItem, "prod_actualprice", 0), _defineProperty(_defaultItem, "prod_eventualprice", 0), _defineProperty(_defaultItem, "prod_preferentialprice", 0), _defineProperty(_defaultItem, "prod_saleprice", 0), _defineProperty(_defaultItem, "prod_listprice", 0), _defineProperty(_defaultItem, "prod_bulk", 0), _defineProperty(_defaultItem, "prod_iva", 0), _defineProperty(_defaultItem, "prod_ieps", 0), _defineProperty(_defaultItem, "prod_packingquantity", 0), _defineProperty(_defaultItem, "prod_minimumpurchase", 0), _defineProperty(_defaultItem, "prod_status", 0), _defineProperty(_defaultItem, "is_mod", false), _defineProperty(_defaultItem, "imageUrl", this.imageUrl), _defaultItem),
      editedIndex: -1,
      products: [],
      categories: [],
      measurements: [],
  ...
  methods: {
    ...
    alta: function alta() {
      ...
      axios.post('/product/add', this.editado).then(function (response) {
        ...
        if (response.data.status.code == 501) {
          _this5.normal('Detalle de validación', 'El campo identificador ya ha sido registrado.', "error");
        ...
        //this.errors.push(e)
        _this5.normal('Notificación', 'Ocurrio un error al intentar guardar los cambios. Intente más tarde.', "error");
      });
    },
    editar: function editar() {
      var _this6 = this;

      axios.post('/product/update', this.editado).then(function (response) {
        console.log(response);

        if (response.data.status.code == 501) {
          _this6.normal('Detalle de validación', 'El campo identificador ya ha sido registrado.', "error");
        } else if (response.data.status.code == 200) {
        ...
        //this.errors.push(e)
        _this6.normal('Notificación', 'Ocurrio un error al intentar guardar los cambios. Intente más tarde.', "error");
      });
    },
    ...
    "delete": function _delete() {
      ...
      axios.post('/product/delete', this.editado).then(function (response) {
        console.log(response);
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("v-text-field", {
                            ...
                            model: {
                              value: _vm.editado.prod_minimumpurchase,
                              callback: function($$v) {
                                _vm.$set(
                                  _vm.editado,
                                  "prod_minimumpurchase",
                                  $$v
                                )
                              },
                              expression: "editado.prod_minimumpurchase"
                            }
                          }),
                          _vm._v(" "),
                          _c("v-text-field", {
