...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    imprimirVenta: function imprimirVenta(id) {//this.normal('Notificación', "Aqui va a imprmir", "error");
      ...
      _c(
        ...
        [
                              ...
                              return [
                                ...
                                _c(
                                  "v-btn",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.imprimirVenta(item.clsa_pk)
                                      }
                                    }
                                  },
                                  [
          ...
          _c(
            "v-dialog",
            {
              attrs: { fullscreen: "", "max-width": "500" },
              model: {
                value: _vm.dialogTicket,
                callback: function($$v) {
                  _vm.dialogTicket = $$v
                },
                expression: "dialogTicket"
              }
            },
            [
              _c(
