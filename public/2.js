...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    guardar: function guardar() {
      if (this.estado == true) this.editado.prca_status = 1;else this.editado.prca_status = 0;
    ...
    editar: function editar() {
      ...
      axios.post('/categories/update', this.editado).then(function (response) {
    ...
    "delete": function _delete() {
      ...
      axios.post('/categories/delete', this.editado).then(function (response) {
                      ...
                      _c(
                        ...
                        [
                          _c("v-text-field", {
                            ...
                            model: {
                              value: _vm.editado.prca_name,
                              callback: function($$v) {
                                _vm.$set(_vm.editado, "prca_name", $$v)
                              },
                              expression: "editado.prca_name"
                            }
                          }),
                          _vm._v(" "),
